...
const RegisterAuctionModal = (props) => {
    ...
    const handleEffect = async () => {
        if (program) {
            const data = await program.account.nftData.fetch(props.address).catch(error => console.log(error));
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            const handleSubmit = async () => {
                ...
                props.setBids((await program.account.nftData.fetch(props.address)).bids)
